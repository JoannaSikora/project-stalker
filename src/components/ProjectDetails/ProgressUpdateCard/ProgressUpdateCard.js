...
import {
    DELETE_PROGRESS_UPDATE_OPTION,
    UPDATE_PROGRESS_UPDATE_OPTION
    ...
    return (
        <div
            ...
            <div className="ProgressUpdateCard_property--description">
                <div
                    className="ProgressUpdateCard_property_label ProgressUpdateCard_property_label--extraPadding">Description:
                </div>
